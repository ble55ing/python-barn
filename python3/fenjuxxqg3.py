...
fr = open(bill_path,'r',encoding='UTF-8')
frsen=""
for line in fr:
  frsen+=line[:-1]
  frsen+='!'
...
doublelist=[]
with open(bill_result_path,'w',encoding='UTF-8') as fw:
...
linelist = []
fxx = open("README.md","r",encoding='UTF-8')
fw = open("README1.md","w",encoding='UTF-8')
for line in fxx:
    res=0
